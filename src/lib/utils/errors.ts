...
export class ProviderAuthenticationError extends AppError { constructor(message = "OpenAI rejected the API key. Check the key and try again.") { super("PROVIDER_AUTHENTICATION", message, 401);} }
export class ProviderRateLimitError extends AppError { constructor(message = "The OpenAI rate limit was reached. Try again later or use another key.") { super("PROVIDER_RATE_LIMIT", message, 429);} }
